...
for file = 1:fileNumel
    ...
    if loadData
        ...
        load(fullfile(dataDir,dataFile{file}));
    ...
    if useGsr
        ...
        [oxyGsr, ~, gsFile, betaFile]=gsr(data,maskFile);
...
image1 = imagesc(mean(lagMatMean,3),[-1 1]);
set(image1,'AlphaData',double(maskHilbert));
colormap('jet');
colorbar();
