...
imagesc(nanmean(lagTimeHb,3),'AlphaData',alphaData & goodPix,tLimHb); axis(gca,'square');
...
imagesc(nanmean(lagTimeFluor,3),'AlphaData',alphaData & goodPix,tLimFluor); axis(gca,'square');
