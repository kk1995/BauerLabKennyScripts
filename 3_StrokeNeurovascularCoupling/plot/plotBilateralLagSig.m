...
for weekInd = 1:4
    ...
    subFolder = [week '_lag_bilateral_' figNameExt];
...
for week = 1:4
    for species = 1:4
        ...
        plotData(:,1:64) = lagMatMean{week,species}(:,1:64);
...
for week = 2:4
    for species = 1:4
        ...
        plotData = nan(128,128);
        plotData(:,1:64) = lagP{week-1,species}(:,1:64);
...
for week = 2:4
    for species = 1:4
        ...
        plotData = nan(128,128);
        plotData(:,1:64) = lagMatMean{week,species}(:,1:64) - lagMatMean{baseWeek,species}(:,1:64);
